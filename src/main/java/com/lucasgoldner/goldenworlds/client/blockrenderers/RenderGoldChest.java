package com.lucasgoldner.goldenworlds.client.blockrenderers;
...
public class RenderGoldChest extends TileEntitySpecialRenderer{

	private static final ResourceLocation texture = new ResourceLocation("goldenworlds:textures/tileentity/chest/gold.png");
	private ModelChest model = new ModelChest();
	
	public RenderGoldChest(){}
	
	public void render(TileEntityGoldChest tileentity, double x, double y, double z, float f) {
	...
	public void renderTileEntityAt(TileEntity tileentity, double i, double j, double k, float f) {
		render((TileEntityGoldChest)tileentity, i, j, k, f);
	}
