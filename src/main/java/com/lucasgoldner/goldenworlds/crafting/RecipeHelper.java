...
import com.lucasgoldner.goldenworlds.blocks.GoldenWorldsModBlock;
import com.lucasgoldner.goldenworlds.items.*;
...
public class RecipeHelper {
	...
	public static String[][] armorPatterns = new String[][] {{"XXX", "X X"}, {"X X", "XXX", "XXX"}, {"XXX", "X X", "X X"}, {"X X", "X X"}};
	...
	public static void addArmorRecipe(ItemGoldenWorldsArmor helmet, ItemGoldenWorldsArmor chestplate, ItemGoldenWorldsArmor leggings, ItemGoldenWorldsArmor boots, GoldenWorldsModItem material){
	...
	public static void addToolRecipe(ItemGoldenWorldsSword sword, ItemGoldenWorldsPickaxe pickaxe, ItemGoldenWorldsAxe axe, ItemGoldenWorldsShovel shovel, ItemGoldenWorldsBow bow, Item arrow, Item material){
	...
	public static void addToolRecipe(ItemGoldenWorldsSword sword, ItemGoldenWorldsPickaxe pickaxe, ItemGoldenWorldsAxe axe, ItemGoldenWorldsShovel shovel, ItemGoldenWorldsBow bow, Item arrow, Item material, Item arrowFin){
	...
	public static void addCannonRecipe(Block block, ItemCannon cannon, Item material, GoldenWorldsModItem bullet){
