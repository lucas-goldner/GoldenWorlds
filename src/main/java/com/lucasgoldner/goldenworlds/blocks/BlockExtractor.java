...
import com.lucasgoldner.goldenworlds.client.blockrenderers.RenderExtractor;
...
import com.lucasgoldner.goldenworlds.GUIHandler;
...
public class BlockExtractor extends BlockContainer {
	...
	public BlockExtractor(boolean active) {
		...
		setBlockTextureName("goldenworlds:extractor");
		isActive = active;
		if(!active){
	...
	public boolean onBlockActivated(World var1, int var2, int var3, int var4, EntityPlayer player, int var6, float var7, float var8, float var9) {
		if (!player.isSneaking()) {
			player.openGui(GoldenWorlds.instance, GUIHandler.extractor, var1, var2, var3, var4);
			return true;
		} else {
			return false;
		}
	...
	public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4) {
		...
		if (par0)
		{
			par1World.setBlock(par2, par3, par4, GoldenWorldsBlocks.extractor_on);
		}
		else
		{
			par1World.setBlock(par2, par3, par4, GoldenWorldsBlocks.extractor);
		}
	...
	public Item func_149694_d(World par1World, int par2, int par3, int par4) {
		return Item.getItemFromBlock(GoldenWorldsBlocks.extractor);
	}
