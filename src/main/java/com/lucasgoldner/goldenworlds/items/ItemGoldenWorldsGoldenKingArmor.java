...
public class ItemGoldenWorldsGoldenKingArmor extends ItemArmor implements ISpecialArmor {
	...
	public ItemGoldenWorldsGoldenKingArmor(ArmorMaterial par1armorMaterial, int piece,
		...
		if (par1armorMaterial == GoldenWorldsItems.IRONa || par1armorMaterial == GoldenWorldsItems.DIAMONDa){
			setCreativeTab(null);
			vanilla = true;
		}else{setCreativeTab(GoldenWorldsTabs.Combat); vanilla = false;}
	...
	public ItemGoldenWorldsGoldenKingArmor register(String name) {
