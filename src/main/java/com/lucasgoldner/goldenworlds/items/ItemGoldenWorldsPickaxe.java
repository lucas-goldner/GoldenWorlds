...
public class ItemGoldenWorldsPickaxe extends ItemGoldenWorldsTool
{
    ...
    protected ItemGoldenWorldsPickaxe(ToolMaterial tool, String tex, String name, boolean vanilla)
    {
    ...
    public ItemGoldenWorldsPickaxe register(String name){
