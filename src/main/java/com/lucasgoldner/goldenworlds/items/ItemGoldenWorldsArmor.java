...
public class ItemGoldenWorldsArmor extends ItemArmor implements ISpecialArmor {
	...
	public ItemGoldenWorldsArmor(ArmorMaterial par1armorMaterial, int piece,
	...
	public ItemGoldenWorldsArmor register(String name) {
