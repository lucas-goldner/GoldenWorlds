...
public class WorldGenWaterMinable extends WorldGenerator
{
    ...
    public WorldGenWaterMinable(Block p_i45459_1_, int p_i45459_2_)
    {
        this(p_i45459_1_, p_i45459_2_, GoldenWorldsBlocks.goldenworlds_stone);
    }

    public WorldGenWaterMinable(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    ...
    public WorldGenWaterMinable(Block block, int meta, int number, Block target)
    {
