...
public class TeleporterGoldenWorlds extends Teleporter {
	...
	public TeleporterGoldenWorlds(WorldServer par1WorldServer) {
				...
				for (int i1 = -2; i1 <= 2; ++i1) {
					for (int j1 = -1; j1 < 3; ++j1) {
						...
						this.worldServerInstance.setBlock(i, j - 1, k,
								GoldenWorldsBlocks.goldenworlds_portal);
						...
						this.worldServerInstance.setBlock(i, j - 5, k,
								GoldenWorldsBlocks.goldenworlds_reacher);
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2,
			...
			for (l3 = l - short1; l3 <= l + short1; ++l3) {
				...
				for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1) {
					...
					for (int i2 = this.worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2) {
						if (this.worldServerInstance.getBlock(l3, i2, l1) == GoldenWorldsBlocks.goldenworlds_portal) {
							while (this.worldServerInstance.getBlock(l3,
									i2 - 1, l1) == GoldenWorldsBlocks.goldenworlds_portal) {
								--i2;
							}
		...
		if (d3 >= 0.0D) {
			...
			if (this.worldServerInstance.getBlock(i - 1, j, k) == GoldenWorldsBlocks.goldenworlds_portal) {
				i4 = 2;
			}

			if (this.worldServerInstance.getBlock(i, j, k) == GoldenWorldsBlocks.goldenworlds_portal) {
				i4 = 0;
			}

			if (this.worldServerInstance.getBlock(i, j, k - 1) == GoldenWorldsBlocks.goldenworlds_portal) {
				i4 = 3;
			}
	...
	public boolean makePortal(Entity par1Entity) {
		...
		this.worldServerInstance.setBlock(i, j - 1, k, GoldenWorldsBlocks.goldenworlds_portal);
		this.worldServerInstance.setBlock(i, j, k, GoldenWorldsBlocks.goldenworlds_portal);
		this.worldServerInstance.setBlock(i, j - 2, k, GoldenWorldsBlocks.goldenworlds_portal);
		this.worldServerInstance.setBlock(i, j - 3, k, GoldenWorldsBlocks.goldenworlds_portal);
		this.worldServerInstance.setBlock(i, j - 4, k, GoldenWorldsBlocks.goldenworlds_portal);
		this.worldServerInstance.setBlock(i, j - 5, k, GoldenWorldsBlocks.goldenworlds_reacher);
		this.worldServerInstance.setBlock(i + 1, j, k,GoldenWorldsBlocks.goldenworlds_reacher);
		this.worldServerInstance.setBlock(i - 1, j, k, GoldenWorldsBlocks.goldenworlds_reacher);
		this.worldServerInstance.setBlock(i, j, k - 1, GoldenWorldsBlocks.goldenworlds_reacher);
		this.worldServerInstance.setBlock(i, j, k + 1, GoldenWorldsBlocks.goldenworlds_reacher);
		this.worldServerInstance.setBlock(i + 1, j - 4, k, GoldenWorldsBlocks.goldenworlds_reacher);
		this.worldServerInstance.setBlock(i - 1, j - 4, k, GoldenWorldsBlocks.goldenworlds_reacher);
		this.worldServerInstance.setBlock(i, j - 4, k - 1, GoldenWorldsBlocks.goldenworlds_reacher);
		this.worldServerInstance.setBlock(i, j - 4, k + 1, GoldenWorldsBlocks.goldenworlds_reacher);
