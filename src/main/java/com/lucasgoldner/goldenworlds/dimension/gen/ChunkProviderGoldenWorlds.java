...
public class ChunkProviderGoldenWorlds implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderGoldenWorlds(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_)
    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                    ...
                                    if(n < 8){
                                        p_147424_3_[j3 += short1] = GoldenWorldsBlocks.goldenworlds_stone;
                                    } else {
                                        p_147424_3_[j3 += short1] = GoldenWorldsBlocks.goldenworlds_cobblestone;
                                    }
